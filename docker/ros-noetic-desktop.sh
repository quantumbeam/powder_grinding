...
sudo apt-get install -y ros-${ROS_DISTRO}-moveit-ros-visualization
sudo apt-get install -y ros-${ROS_DISTRO}-ros-control
sudo apt-get install -y ros-${ROS_DISTRO}-ros-controllers
sudo apt-get install -y ros-${ROS_DISTRO}-trac-ik
# sudo apt-get install -y ros-${ROS_DISTRO}-industrial-robot-status-controller
