^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package grinding_robot_gazebo
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* [grinding_robot_gazebo] update effort_controllers' pid parameters
* [grinding_robot_gazebo] Switch to effort controllers
* [grinding_robot_gazebo] Switch common files to effort controllers
...
* Make grinding_robot_gazebo robot name consistent with ur_description (`#615 <https://github.com/ros-industrial/universal_robot/issues/615>`_)
...
* grinding_robot_gazebo: Update path ur ur_macro.xacro
...
* Merge pull request `#518 <https://github.com/ros-industrial/universal_robot/issues/518>`_ from gavanderhoorn/gazebo_updates
  ...
  - clean up "public API" of `grinding_robot_gazebo` (ie: `.launch` and `_macro.xacro` files )
...
* change gazebo launch file and tests
  * added e-series
* create urdf files for grinding_robot_gazebo
...
1.1.8 (2016-12-30)
------------------
* grinding_robot_gazebo: escape underscore in changelog (`#279 <https://github.com/ros-industrial/universal_robot/issues/279>`_).
* all: update maintainers.
* Contributors: gavanderhoorn

1.1.7 (2016-12-29)
------------------
* grinding_robot_gazebo: add controller_manager as run dependency.
